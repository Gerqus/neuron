...
export class Neuron {
  ...
  private derivativeCalcResult: number | undefined;
  ...
  constructor(
    ...
    public calculateDelta(): void {
      ...
      if (!this.derivativeCalcResult) {
        throw Error('Derivative was not calculated before use');
      }
